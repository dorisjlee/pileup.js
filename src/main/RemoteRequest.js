...
////  }
//
//  getUrl(range: ContigInterval) {
//    urlPrefix + "/" + range.contig + "?start=" + range.start() + "&end=" + range.end();
//  }
//
//  getFromNetwork(range: ContigInterval): Q.Promise<ArrayBuffer> {
